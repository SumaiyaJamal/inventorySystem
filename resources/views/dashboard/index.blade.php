						...
						<div class="col-xl-6 col-xxl-5 d-flex">
							<div class="w-100">
								<div class="row">
									...
									@if($showLedLight)
										<div class="col-sm-6">
											<a href="{{ route('inventory.led-lights') }}" class="text-decoration-none">
												<div class="card">
													<div class="card-body text-center">
														<div class="mb-3">
															<div class="stat text-primary" style="font-size: 3rem;">
																<i class="align-middle" data-feather="zap"></i>
															</div>
														</div>
														<h5 class="card-title mb-0">Tube Light & Bulbs</h5>
													</div>
												</div>
											</a>
										</div>
									...
									@if($showSpices)
										<div class="col-sm-6">
											<a href="{{ route('inventory.spices') }}" class="text-decoration-none">
												<div class="card">
													<div class="card-body text-center">
														<div class="mb-3">
															<div class="stat text-warning" style="font-size: 3rem;">
									...
									@if(!$showLedLight && !$showSpices && !auth()->user()->hasRole('salesman'))
										<div class="col-12">
											<div class="alert alert-warning">
												<i class="align-middle me-2" data-feather="alert-circle"></i>
												No inventory type assigned. Please contact administrator.
											</div>
										</div>
									@endif
								</div>
