...
<head>
	...
	<title>Salesmen | AdminKit Demo</title>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="d-flex justify-content-between align-items-center mb-3">
						<h1 class="h3 mb-0"><strong>Salesmen</strong> Management</h1>
						...
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title mb-0">Salesmen List</h5>
								</div>
								<div class="card-body">
									@if($salesmen->count() > 0)
												...
												<tbody>
													@foreach($salesmen as $salesman)
														<tr>
															...
															<td class="d-none d-md-table-cell">{{ $salesman->location ?? 'N/A' }}</td>
															<td class="d-none d-xl-table-cell">{{ $salesman->created_at->format('M d, Y') }}</td>
															<td>
																<div class="d-flex gap-1">
																	<a href="{{ route('salesmen.edit', $salesman) }}" class="btn btn-sm btn-primary" title="Edit">
																		<i class="align-middle" data-feather="edit-2" style="width: 14px; height: 14px;"></i>
																	</a>
																	<form action="{{ route('salesmen.destroy', $salesman) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this salesman?');">
																		@csrf
																		@method('DELETE')
									...
									@else
										<div class="alert alert-info text-center">
											...
											No salesmen found. Please add some salesmen to get started.
										</div>
									@endif
								</div>
							</div>
